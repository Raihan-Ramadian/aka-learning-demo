...
import { ArrowLeft, Plus, FileText, Video, Download, Upload, Users, Calendar, Clock, GripVertical } from "lucide-react";
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4">
              {assignmentsData.map((assignment, index) => (
                <div
                  key={assignment.id}
                  className="rounded-xl border border-border bg-card p-5 shadow-card hover:shadow-lg transition-all animate-fade-in"
                  style={{ animationDelay: `${index * 100}ms` }}
                >
